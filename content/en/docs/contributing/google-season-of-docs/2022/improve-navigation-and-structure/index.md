...
Nor will a Cluster Administrator easily find information about how to optimise cert-manager for a large cluster with many Certificates.
...
we will measure a baseline number of clicks required to achieve the task and we will aim to minimise the number of clicks for each task.
